<nav class="p-3 px-lg-5 bg-white border-bottom shadow-sm navbar navbar-expand-lg navbar-light">
	<a href="#" class="navbar-brand ml-5"><img src="../resources/images/logo.jpg" width="120" class=""></a>
	...
	<div class="collapse navbar-collapse" id="navbartoggler">
		<ul class="navbar-nav mr-lg-0 mx-auto text-center">
			...
			if(isset($_GET['register'])):
				...
				<li class="nav-item">
					Already Registered?
					<a class="btn btn-outline-primary mr-5 ml-5" href="/">Log in</a>
				</li>
				<?php 
				elseif((Request::uri()=='')||(Request::uri()=='index.php')||(Request::uri()=='index')):?>
					<li class="nav-item">
						New to eLibrary?
						<a class="btn btn-outline-primary mr-5 ml-5" href="/index?register=1">Join Now</a></li>		
						<?php
						elseif($type=='inreader'): ?>
							...
							<li class="nav-item">
								<a class="btn btn-link" href="javascript:void(0);">List of Read Books</a>
							</li>	
							<li class="nav-item">
